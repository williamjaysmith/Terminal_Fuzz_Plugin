...
/**
 * @brief Main Fuzz Module - Component-level recreation of Terminal Fuzz circuit
 * 
 * This module implements the complete signal path of the fuzz circuit with
 * authentic component modeling and transistor physics.
 */
class FuzzCircuit {
public:
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(FuzzCircuit)
};
